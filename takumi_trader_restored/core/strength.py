...
class CalculationEngine:
    ...
    def update_momentum(
        ...
        for ccy in CURRENCIES:
            ...
            # ── Classify acceleration magnitude ──
    ...
    def check_acceleration_entry(
        ...
        # Check at least one has "strong" or "explosive" magnitude
        magnitudes = (base_phase.accel_magnitude, quote_phase.accel_magnitude)
        if "explosive" not in magnitudes and "strong" not in magnitudes:
            return False, ""
